...
namespace MailDownloaderConsoleTest
{
    ...
    class Program
    {
        ...
        {
            MultiMailDownloadManager mmdm = new MultiMailDownloadManager();
            Console.WriteLine("Enter your email login:");
            string login = Console.ReadLine();
            Console.WriteLine("Enter your email pass:");
            string pass = Console.ReadLine();
            mmdm.StartDownloading(new Mail(login, pass));
        }
    }
}
